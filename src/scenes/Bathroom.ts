...
export default class Bathroom extends Phaser.Scene {
    private player!: Player

	constructor() {
		super(SceneKeys.Bathroom)
	}

	create() {
        this.add.text(10, 10, 'Bathroom', { color: '#000' })

        this.physics.world.setBounds(0, 0, 400, 300)
        
        const floor = this.add.tileSprite(0, 0, 400, 300, 'tiles')
        floor.setOrigin(0, 0)
        floor.setTint(0xccccff)
        ...
        const door = this.add.rectangle(200, 250, 32, 32, 0x0000ff)
